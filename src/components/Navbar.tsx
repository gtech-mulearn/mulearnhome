                              ...
                              <ul className="list-none m-0 p-0 flex flex-col gap-0.5 lg:gap-0">
                                {items.map(
                                  (subItem: SubItem, subIndex: number) => (
                                    <li
                                      key={subIndex}
                                      className="text-gray-600 text-[0.7rem] font-bold cursor-pointer rounded-lg transition-all duration-300 hover:bg-blue-50 hover:text-blue-600 lg:text-[0.8rem] lg:px-2 lg:py-1 leading-snug relative after:absolute after:left-0 after:bottom-0 after:w-0 after:h-0.5 after:bg-blue-600 after:transition-all after:duration-500 hover:after:w-full"
                                    >
                            ...
                            <ul className="pl-4 list-none">
                              {items.map(
                                (subItem: SubItem, subIndex: number) => (
                                  <li
                                    key={subIndex}
                                    className="py-2 text-gray-600 cursor-pointer hover:text-[color:var(--PrimaryDark)] hover:pl-2"
                                    onClick={() =>

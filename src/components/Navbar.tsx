              ...
              >
                ...
                <AnimatePresence>
                  {activeSubmenu === index && item.submenu && (
                    <motion.div
                      className="absolute top-full left-1/2 -translate-x-1/2 bg-[var(--mulearn-whitish)] rounded-xl shadow-[0_10px_40px_rgba(0,0,0,0.15)] border border-[var(--mulearn-greyish)] z-[1000] overflow-hidden mt-2 lg:min-w-[240px]"
          ...
          <AnimatePresence>
            {isMenuOpen && (
              <>
                ...
                >
                  <motion.button
                    className="absolute top-6 right-4 cursor-pointer text-[var(--mulearn-gray-600)] w-10 h-10 flex items-center justify-center"
                    onClick={() => setIsMenuOpen(false)}

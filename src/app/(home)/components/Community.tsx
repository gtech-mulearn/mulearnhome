    ...
    <div className="px-4 sm:px-8 md:px-16 lg:px-32 xl:px-48 w-full">
      ...
      >
        <motion.div
          ...
          variants={fadeInUp}
        >
          <h1 className="text-4xl sm:text-5xl lg:text-[3.5rem] font-bold text-left max-w-[40rem] mb-5 leading-normal">
            Learn and Grow{" "}
            <span className="text-[var(--mulearn-trusty-blue)]">Together</span>{" "}
            as a{" "}
            <span className="text-[var(--mulearn-trusty-blue)]">Community</span>
          </h1>
          <h6 className="font-normal mb-8 max-w-[800px] text-left text-lg sm:text-xl text-[var(--mulearn-gray-600)] mt-2.5">
          ...
          <Link
            ...
            className="inline-flex justify-center items-center bg-[var(--mulearn-trusty-blue)] px-6 py-4 text-[var(--mulearn-whitish)] rounded-[10px] hover:opacity-90 hover:bg-[var(--mulearn-duke-purple)] transition-all duration-300 text-center"
          >
            Join The Community
          </Link>
        </motion.div>

...
export default function TextTestimonialCard({ testimonial }: TextTestimonialCardProps) {
  ...
  const getTypeColor = (type: TextTestimonial['type']) => {
    switch (type) {
      case 'learner': return 'bg-mulearn-trusty-blue text-mulearn-whitish';
      case 'mentor': return 'bg-mulearn-electric-purple text-mulearn-whitish';
      case 'partner': return 'bg-mulearn-gray-600 text-mulearn-whitish';
      case 'community-leader': return 'bg-mulearn-trusty-blue text-mulearn-whitish';
      default: return 'bg-mulearn-gray-500 text-mulearn-whitish';
    }
  };

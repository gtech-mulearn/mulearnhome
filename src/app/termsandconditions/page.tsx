    ...
    return (
        <>
            ...
            <div className="mx-auto max-w-5xl lg:max-w-6xl px-4 sm:px-6 lg:px-8 py-16 text-gray-700 text-base lg:text-lg leading-relaxed">
                <h2 className="text-3xl lg:text-4xl font-bold mb-10 text-center text-gray-900">TERMS OF SERVICES</h2>
                ...
                <ol className="space-y-12">
                    <li className="space-y-5">
                        <strong className="text-2xl font-bold text-gray-900">Definitions:</strong>
                        <ol className="list-[lower-roman] pl-6 lg:pl-8 space-y-4 text-gray-800">
                            <li>
                                <strong className="font-semibold text-gray-900">Confidential Information</strong> means information
                            ...
                            <li>
                                <strong className="font-semibold text-gray-900">Intellectual Property Rights</strong> means and includes
                            ...
                            <li>
                                <strong className="font-semibold text-gray-900">Representative</strong> means any director, officer,
                                employee, agent or professional advisor of μLearn.
                            </li>
                            <li>
                                <strong className="font-semibold text-gray-900">Services</strong> means the services more particularly
                                described in Clause 2 of these Terms.
                            </li>
                            <li>
                                <strong className="font-semibold text-gray-900">Training or Training Material(s)</strong> means the
                                orientation programs, webinars, training or training materials
                                provided by µLearn from time to time in the course of the
                                delivery of our Services.
                            </li>
                            <li>
                                <strong className="font-semibold text-gray-900">Website</strong> means https://mulearn.org/ owned and
                                maintained by μLearn.
                            </li>
                            <li>
                                <strong className="font-semibold text-gray-900">You or you or your or yourself</strong> refers to the
                                individual/user who uses the Services.
                            </li>
                        </ol>
                    </li>
                    <li className="space-y-5">
                        <strong className="text-2xl font-bold text-gray-900">Services:</strong>
                        <ol className="list-[lower-roman] pl-6 lg:pl-8 space-y-4 text-gray-800">
                            <li>
                    ...
                    <li className="space-y-5">
                        <strong className="text-2xl font-bold text-gray-900">Password Use and Security:</strong>
                        <ol className="list-[lower-roman] pl-6 lg:pl-8 space-y-4 text-gray-800">
                            <li>
                    ...
                    <li className="space-y-5">
                        <strong className="text-2xl font-bold text-gray-900">License Grant and Proprietary Rights:</strong>
                        <ol className="list-[lower-roman] pl-6 lg:pl-8 space-y-4 text-gray-800">
                            <li>
                    ...
                    <li className="space-y-5">
                        <strong className="text-2xl font-bold text-gray-900">Code of Conduct: </strong>
                        <ol className="list-[lower-roman] pl-6 lg:pl-8 space-y-4 text-gray-800">
                            <li>
                    ...
                    <li className="space-y-5">
                        <strong className="text-2xl font-bold text-gray-900">Liability:</strong>
                        <ol className="list-[lower-roman] pl-6 lg:pl-8 space-y-4 text-gray-800">
                            <li>
                    ...
                    <li className="space-y-5">
                        <strong className="text-2xl font-bold text-gray-900">Disclaimer: </strong>
                        <ol className="list-[lower-roman] pl-6 lg:pl-8 space-y-4 text-gray-800">
                            <li>
                    ...
                    <li className="space-y-5">
                        <strong className="text-2xl font-bold text-gray-900">Confidentiality: </strong>
                        <ol className="list-[lower-roman] pl-6 lg:pl-8 space-y-4 text-gray-800">
                            <li>
                            ...
                            <li>
                                ...
                                shall destroy or return all Confidential Information received from
                                the other party and confirm the same in writing.
                            </li>
                            <li>
                    ...
                    <li className="space-y-5">
                        <strong className="text-2xl font-bold text-gray-900">Termination: </strong>
                        <ol className="list-[lower-roman] pl-6 lg:pl-8 space-y-4 text-gray-800">
                            <li>
                            ...
                            <li>
                                ...
                                contravention of the access rules (set out in Clauses 4.1,
                                4.4, 4.5 and 4.6), we may terminate your access to μLearn
                                platform.
                            </li>
                            <li>
                    ...
                    <li className="space-y-5">
                        <strong className="text-2xl font-bold text-gray-900">Privacy Policy: </strong>
                        <ol className=" pl-6 lg:pl-8 space-y-4 text-gray-800">
                            <li>Please view our privacy policy for more details.</li>
                        </ol>
                    </li>
                    <li className="space-y-5">
                        <strong className="text-2xl font-bold text-gray-900">Indemnification: </strong>
                        <ol className=" pl-6 lg:pl-8 space-y-4 text-gray-800">
                            <li>
                    ...
                    <li className="space-y-5">
                        <strong className="text-2xl font-bold text-gray-900">Force Majeure: </strong>
                        <ol className=" pl-6 lg:pl-8 space-y-4 text-gray-800">
                            <li>
                    ...
                    <li className="space-y-5">
                        <strong className="text-2xl font-bold text-gray-900">Amendment: </strong>
                        <ol className=" pl-6 lg:pl-8 space-y-4 text-gray-800">
                            <li>
                    ...
                    <li className="space-y-5">
                        <strong className="text-2xl font-bold text-gray-900">General terms:</strong>
                        <ol className=" pl-6 lg:pl-8 space-y-4 text-gray-800">
                            <li>
                    ...
                    <li className="space-y-5">
                        <strong className="text-2xl font-bold text-gray-900">Governing Law & Jurisdiction:</strong>
                        <ol className="pl-6 lg:pl-8 space-y-4 text-gray-800">
                            <li>
                    ...
                    <li className="space-y-5">
                        <strong className="text-2xl font-bold text-gray-900">Contact Information: </strong>
                        <ol className="pl-6 lg:pl-8 space-y-4 text-gray-800">
                            <li>
                                ...
                                - 695581, Kerala, India<br />
                                Telephone : +91 99957 10101 <br />
                            </li>
                        </ol>
                    </li>
                    <li className="space-y-5">
                        <strong className="text-2xl font-bold text-gray-900">Cookies and similar technologies:</strong>
                        <ol className="pl-6 lg:pl-8 space-y-4 text-gray-800">
                            <li>
                    ...
                    <li className="space-y-5">
                        <strong className="text-2xl font-bold text-gray-900">Terms of Service:</strong>
                        <ol className="pl-6 lg:pl-8 space-y-4 text-gray-800">
                            <li>

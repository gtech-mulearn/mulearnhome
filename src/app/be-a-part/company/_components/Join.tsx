      ...
      <div className="max-w-5xl mx-auto">
        ...
        >
          <button
            ...
            className="cursor-pointer bg-gradient-to-r from-mulearn-trusty-blue to-mulearn-duke-purple hover:opacity-90 text-white px-4 py-3 text-md font-bold rounded-[20px] transition-all"
          >

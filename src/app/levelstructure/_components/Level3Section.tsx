          ...
          >
            ...
            <div className="space-y-6">
              <p className="text-lg text-mulearn-blackish leading-relaxed">
                At this point, tools become the <span className="font-semibold text-mulearn-trusty-blue">compass</span>. Knowledge transforms from abstract to actionable.
              </p>
              ...
              <div className="space-y-3 pt-4">
                <div className="pl-4 border-l-2 border-mulearn-trusty-blue">
                  <p className="text-sm text-mulearn-blackish">
                    ...
                    <span className="text-mulearn-gray-600">&ldquo;GitHub, hosting, and Figma become my workflow.&rdquo;</span>
                  </p>
                </div>
                ...
                <div className="pl-4 border-l-2 border-mulearn-duke-purple">
                  <p className="text-sm text-mulearn-blackish">
                    ...
                    <span className="text-mulearn-gray-600">&ldquo;HuggingFace and ChatGPT streamline my workflows.&rdquo;</span>
                  </p>
                </div>
                ...
                <div className="pl-4 border-l-2 border-mulearn-trusty-blue">
                  <p className="text-sm text-mulearn-blackish">
                    ...
                    <span className="text-mulearn-gray-600">&ldquo;DaVinci Resolve and AI editing tools unlock creativity.&rdquo;</span>
                  </p>
                </div>
                ...
                <div className="pl-4 border-l-2 border-mulearn-duke-purple">
                  <p className="text-sm text-mulearn-blackish">
                    ...
                    <span className="text-mulearn-gray-600">&ldquo;AutoCAD + Project Management tools bring ideas to life.&rdquo;</span>
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-mulearn-gray-50 rounded-2xl p-6 space-y-3">
              ...
              <p className="text-base text-mulearn-gray-600 leading-relaxed">
                Students move from passive learners to active creators. They <span className="font-semibold text-mulearn-blackish">command technology</span> instead of being commanded by it.
              </p>
            </div>
          </motion.div>

          {/* Right Content - UFO with Floating Icons */}
          <motion.div

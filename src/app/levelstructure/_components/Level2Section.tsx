          ...
          >
            ...
            <div className="space-y-4">
              ...
              <p className="text-xl text-mulearn-gray-600">
                From <span className="text-mulearn-trusty-blue font-semibold">Fixed</span> → <span className="text-mulearn-trusty-blue font-semibold">Growth</span> → <span className="text-mulearn-trusty-blue font-semibold">Abundance</span>
              </p>
            </div>
            ...
            <div className="space-y-6">
              <p className="text-lg text-mulearn-blackish leading-relaxed">
                Most students walk into μLearn trapped in <span className="font-semibold text-mulearn-duke-purple">invisible cages</span>.
              </p>
              
              <p className="text-base text-mulearn-gray-600 leading-relaxed">
                μLearn rewires these narratives. Through experiences, reflection spaces, and peer nudges, a fixed mindset stretches into a growth mindset… and finally into abundance thinking.
              </p>
              ...
              <div className="space-y-3 pt-4">
                <div className="pl-4 border-l-2 border-mulearn-duke-purple">
                  <p className="text-sm text-mulearn-blackish">
                    ...
                    <span className="text-mulearn-gray-600">&ldquo;I&apos;ll never be good enough to compete globally.&rdquo;</span>
                  </p>
                </div>
                ...
                <div className="pl-4 border-l-2 border-mulearn-trusty-blue">
                  <p className="text-sm text-mulearn-blackish">
                    ...
                    <span className="text-mulearn-gray-600">&ldquo;I doubt whether my passion has career potential.&rdquo;</span>
                  </p>
                </div>
                ...
                <div className="pl-4 border-l-2 border-mulearn-duke-purple">
                  <p className="text-sm text-mulearn-blackish">
                    ...
                    <span className="text-mulearn-gray-600">&ldquo;I feel locked out because labs are pricey.&rdquo;</span>
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-mulearn-gray-50 rounded-2xl p-6 space-y-3">
              ...
              <p className="text-base text-mulearn-gray-600 leading-relaxed">
                Students internalize grit, self-learning, and peer collaboration. Failure becomes feedback. <span className="font-semibold text-mulearn-blackish">Peers become allies, not competitors</span>.
              </p>
            </div>
          </motion.div>
        </div>

          ...
          >
            <div className="space-y-4">
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-mulearn-blackish leading-tight">
                The Path of <span className="text-mulearn-duke-purple">Choice</span>
              </h2>
            ...
            <div className="space-y-6">
              <p className="text-lg text-mulearn-blackish leading-relaxed">
                This is where the hero chooses their <span className="font-semibold text-mulearn-duke-purple">tribe</span>. Students anchor under mentors & industry-aligned pathways.
              </p>
              ...
              <div className="space-y-3 pt-4">
                <div className="pl-4 border-l-2 border-mulearn-duke-purple">
                  <p className="text-sm text-mulearn-blackish">
                    ...
                    <span className="text-mulearn-gray-600">&ldquo;Driven by algorithms and machine learning.&rdquo;</span>
                  </p>
                </div>
                ...
                <div className="pl-4 border-l-2 border-mulearn-trusty-blue">
                  <p className="text-sm text-mulearn-blackish">
                    ...
                    <span className="text-mulearn-gray-600">&ldquo;Chasing digital experiences and interfaces.&rdquo;</span>
                  </p>
                </div>
                ...
                <div className="pl-4 border-l-2 border-mulearn-duke-purple">
                  <p className="text-sm text-mulearn-blackish">
                    ...
                    <span className="text-mulearn-gray-600">&ldquo;Telling stories with light and motion.&rdquo;</span>
                  </p>
                </div>
                ...
                <div className="pl-4 border-l-2 border-mulearn-trusty-blue">
                  <p className="text-sm text-mulearn-blackish">
                    ...
                    <span className="text-mulearn-gray-600">&ldquo;Bold ones touching the stars and circuits.&rdquo;</span>
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-mulearn-gray-50 rounded-2xl p-6 space-y-3">
              ...
              <p className="text-base text-mulearn-gray-600 leading-relaxed">
                Learners start building <span className="font-semibold text-mulearn-blackish">portfolios of proof-of-work</span> within their chosen interest group. No more drifting through scattered learning.
              </p>
            </div>
          </motion.div>

          {/* Right Content - Interest Groups Grid */}
          <motion.div

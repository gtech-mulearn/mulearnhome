        ...
        >
          ...
          <div className="space-y-6">
            <h2 className="text-5xl md:text-6xl lg:text-7xl font-black text-mulearn-blackish leading-tight">
              Welcome to the <span className="text-mulearn-duke-purple">μVerse</span>
            </h2>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="space-y-3">
              <h3 className="text-2xl font-bold text-mulearn-trusty-blue">Access</h3>
              <p className="text-base text-mulearn-gray-600 leading-relaxed">
                Direct pathways to fellowships, startups, and global opportunities curated for your journey.
              </p>
            </div>

            <div className="space-y-3">
              <h3 className="text-2xl font-bold text-mulearn-duke-purple">Network</h3>
              <p className="text-base text-mulearn-gray-600 leading-relaxed">
            ...
            <div className="space-y-3">
              <h3 className="text-2xl font-bold text-mulearn-trusty-blue">Impact</h3>
              <p className="text-base text-mulearn-gray-600 leading-relaxed">
                Build solutions that matter, ship to real users, and contribute to meaningful projects.
              </p>
            </div>
          </div>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
              <Card className="border-t-4 border-t-mulearn-trusty-blue w-full h-58 flex flex-col">
                <CardHeader className="flex-1 flex flex-col justify-center p-4">
                  <CardTitle className="text-mulearn-blackish text-xl">Global Fellowship Programs</CardTitle>
              ...
              <Card className="border-t-4 border-t-mulearn-trusty-blue w-full h-58 flex flex-col">
                <CardHeader className="flex-1 flex flex-col justify-center p-4">
                  <CardTitle className="text-mulearn-blackish text-xl">Fast-Scaling Startups</CardTitle>
                  <CardDescription className="text-mulearn-gray-600 text-xs">
              ...
              <Card className="border-t-4 border-t-mulearn-trusty-blue w-full h-58 flex flex-col">
                <CardHeader className="flex-1 flex flex-col justify-center p-4">
                  <CardTitle className="text-mulearn-blackish text-xl">Entrepreneurial Ventures</CardTitle>
                  <CardDescription className="text-mulearn-gray-600 text-xs">
              ...
              <Card className="border-t-4 border-t-mulearn-trusty-blue w-full h-58 flex flex-col">
                <CardHeader className="flex-1 flex flex-col justify-center p-4">
                  <CardTitle className="text-mulearn-blackish text-xl">Industry  Leadership</CardTitle>
                  <CardDescription className="text-mulearn-gray-600 text-xs">
          ...
          <div className="space-y-6 pt-8">
            ...
            <p className="text-lg md:text-xl text-mulearn-blackish leading-relaxed max-w-3xl mx-auto">
              The μVerse is not a destination. It&apos;s a continuous cycle of learning, building, and contributing that keeps you growing throughout your career.
            </p>
          </div>
        </motion.div>
      </div>
